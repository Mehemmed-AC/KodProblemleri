...
//Burdaki Problem Bir Setirin Lazimsiz Yere Koda Daxil Edilmesidir Bu Bir Setirlik Kodu 
//Programnan Qaldiracayaiq
...
public boolean isdifadeciyoxlayici(String yeni_melumat, String durum) throws IOException{
        ...
        if(bayrag == false){
            ...
            if(!durum.equals("no standart")){         
                ...
                String gizli_melumat_oxumaqucun = new String(encrypt(yeni_melumat.getBytes()));
                gizli_melumat_oxumaqucun += ("\n"+gzili_yeni_melumat);
                Dosya_yaz((gizli_melumat_oxumaqucun), "IsdifadecilerUsers.iu");
            } else {
